  ...
  return (
    <>
      <Layoutpage>
        <div className="pt-20">
          <div className="pb-6">
            <Banner Title="Ideas"></Banner>
          </div>
          <div className="flex-1 flex justify-between items-center">
            <h1 className="text-black">Showing 1-{perPage} of 100</h1>
          ...
          {loading ? (
            ...
            <div class="grid grid-cols-4 gap-y-4 mt-8">
              {data?.data?.map((item) => (
                <div className="flex-grow rounded-xl shadow-md flex flex-col max-w-72">
